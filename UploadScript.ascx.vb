...
#Region " Upload"
            ...
            Try
                ...
                If postedFile.FileName <> "" Then
                    If strExtension.ToLower = ".zip" Then
                        ...
                        objLbl.Text = UploadScript(MapPath("Standard"), postedFile.InputStream)
                        phPaLogs.Controls.Add(objLbl)
                    Else
                        strMessage += "Unable to process file. Script file must be a valid zip file!"
                    End If
                Else
        ...
        Public Shared Function UploadScript(ByVal RootPath As String, ByVal objInputStream As Stream) As String
